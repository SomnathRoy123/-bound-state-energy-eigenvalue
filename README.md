...
*(Visual results generated by the code)*

| Energy Levels | Phase Space Orbits |
| :---: | :---: |
| ![Energy Levels](plots/energy_levels.png) | ![Phase Space](plots/phase_space_orbits.png) |
| *Bound states in the LJ well* | *Quantized trajectories* |
